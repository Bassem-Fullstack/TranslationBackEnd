...
res.status(200).json({
 ...
 translation // دة الرد بتاع نرجع رد بسرعة استجابة عالية بدل ما بياخد وقت في ترجمة كلمة بس ai عشان ناخدوة ونخزنوة عندنا في ستيت على طول عشان يستجيب ويبقي سريع
